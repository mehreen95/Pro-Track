      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
        ...
        <div className='h-full w-full lg:w-2/3 flex flex-col items-center justify-center'>
          <div className='w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5
                md:gap-y-10 2xl:mt-20 mt-20'>
            <span className='flex gap-1 py-1 px-3 border rounded-full texts-sm md:text-base border-gray-300 text-gray-600'>
          ...
          >
            ...
            <div className='flex flex-col gap-y-5'>
              ...
              <span className='text-sm text-gray-500
                        hover:text-blue-600 hover:blue-underline cursor-pointer'>
                Forget Password
              </span>
