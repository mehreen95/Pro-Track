...
import { useGetSingleProjectQuery, usePostProjectActivityMutation } from "../redux/slices/api/projectApiSlice";
              ...
              <div className='w-full md:w-1/2 space-y-8'>
                <div className='flex items-center gap-5'>
                  ...
                  <div className={clsx("flex items-center gap-2")}>
                    ...
                    />
                    <span className='text-black uppercase'>{project?.stage}</span>
                  </div>
                </div>

                <p className='text-gray-500'>
                  Created At: {new Date(project?.date).toDateString()}
                </p>
