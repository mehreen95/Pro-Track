...
import AddSubProject from './project/AddSubProject';
    ...
    <>
      <div className='w-full h-fit bg-white shadow-md p-4 rounded'>
        <div className='w-full flex justify-between'>
          ...
          {user?.isAdmin && <ProjectDialog task={task} />}
        ...
        {task?.subTasks?.length > 0 ? (
          ...
          <>
            <div className='py-4 border-gray-200'>
              <span className='text-gray-500'>No Sub-Project</span>
            </div>
          </>
        )}
      ...
      {/* <AddSubProject open={open} setOpen={setOpen} id={task._id} /> */}
    </>
  );
};
